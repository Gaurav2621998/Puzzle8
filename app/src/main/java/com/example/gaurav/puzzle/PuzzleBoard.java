    ...
    PuzzleBoard(Bitmap bitmap, int parentWidth) {
        ...
        for(int y=0;y<NUM_TILES;y++)
        {
            for(int x=0;x<NUM_TILES;x++)
            {
                ...
                {
                    int xx=x*scaledBitmap.getWidth()/NUM_TILES;
                    int yy=y*scaledBitmap.getWidth()/NUM_TILES;
                    int width=parentWidth/NUM_TILES;
                    int height=parentWidth/NUM_TILES;
                    Bitmap tileBitmap=Bitmap.createBitmap(scaledBitmap,xx,yy,width,height);
                    //create puzzle tile
